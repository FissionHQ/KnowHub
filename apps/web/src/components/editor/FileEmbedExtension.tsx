...
function FilePreview({ fileType, url, attachmentId, fileName }: { fileType: string; url: string; attachmentId: string; fileName: string }) {
  ...
  return (
    <div className="p-2">
      ...
      <iframe
        src={previewUrl}
        className={`w-full h-[500px] rounded border border-border bg-white ${loading ? "hidden" : ""}`}
        ...
        <div className="flex items-center gap-2.5 px-3 py-2.5">
          ...
          {status === "ready" && previewable && (
            <button
              ...
              className="flex items-center gap-1.5 px-2 py-1 rounded-md text-xs font-medium text-muted-foreground hover:bg-accent dark:hover:bg-accent transition-colors shrink-0"
          ...
          <button
            ...
            className="p-1.5 rounded-md hover:bg-red-100 dark:hover:bg-red-900/30 text-muted-foreground hover:text-red-500 transition-colors shrink-0"
