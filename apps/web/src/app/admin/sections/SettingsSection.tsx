    ...
    <Card>
      <CardContent className="p-6">
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-4 max-w-lg">
          ...
          <label className="flex flex-col gap-1.5">
            <span className="text-sm text-muted-foreground">Max upload size (MB)</span>
            <input
              type="number"
              min={1}
              max={500}
          ...
          <label className="flex flex-col gap-1.5">
            <span className="text-sm text-muted-foreground">Trash retention (days)</span>
            <input
              type="number"
              min={1}
              max={365}
          ...
          <label className="flex flex-col gap-1.5">
            <span className="text-sm text-muted-foreground">Primary color (hex)</span>
            <input
              value={primaryColor}
